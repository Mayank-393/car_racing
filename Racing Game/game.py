...
display=pygame.display.set_mode((800,600))		#set width & height of display
...
def crash():		#create crash function to display this message
	message_display("Car Crashed Try Again")	#display this message call the message_display function
	
def message_display(text):		#create function for message edit
	largetext=pygame.font.Font("freesansbold.ttf",50)	#message in this style and the size will be 80
